...
- Web Shell uses administrator browser sessions, CSRF-protected single-use tickets and bounded WebSocket relays; credential or VM lifecycle changes close active shells.
