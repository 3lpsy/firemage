...
- `kernel list/upload/download/alias/delete` manages the server catalog by filename. Upload/download require `--alias`; downloads also require SHA-256. Writes require an administrator.
