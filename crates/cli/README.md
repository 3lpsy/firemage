...
- `kernel list/upload/download/alias/delete` manages the server catalog by filename. Upload/download require `--alias`; downloads accept optional SHA-256 verification. Writes require an administrator.
